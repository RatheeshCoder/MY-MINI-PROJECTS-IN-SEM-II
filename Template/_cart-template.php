                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="qty d-flex pt-2">
                            ...
                            <form method="post">
                                ...
                                <button type="submit" name="delete-cart-submit" class="btn font-baloo text-danger px-3 border-right"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
